...
extension ProjectQueryWhereSort on QueryBuilder<Project, Project, QWhere> {
  ...
  QueryBuilder<Project, Project, QAfterWhere> anyTitle() {
    return QueryBuilder.apply(this, (query) {
...
extension ProjectQueryWhere on QueryBuilder<Project, Project, QWhereClause> {
  ...
  QueryBuilder<Project, Project, QAfterWhereClause> titleEqualTo(String title) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterWhereClause> titleNotEqualTo(
      String title) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Project, Project, QAfterWhereClause> titleGreaterThan(
    String title, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterWhereClause> titleLessThan(
    String title, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterWhereClause> titleBetween(
    String lowerTitle,
    String upperTitle, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Project, Project, QAfterWhereClause> titleStartsWith(
      String TitlePrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'title',
  ...
  QueryBuilder<Project, Project, QAfterWhereClause> titleIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'title',
        value: [''],
  ...
  QueryBuilder<Project, Project, QAfterWhereClause> titleIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
